...
function addFav(superHeroID){
    ...
    likeButton.innerHTML = `<span id="dislike" onclick="removeFav(${superHeroID})" ><i class="fa-solid fa-heart-circle-xmark"></i></i></span>`
}
...
async function fetchHero() {
    ...
    if(name.length != 0){
        ...
        superHeroList.innerHTML = `<div id="loading"><br>Loading......</div>`;
        superHeroList.innerHTML = `<div id="loading">`;
        let tempList = "";
